  ...
  return (
    <div className="w-full min-h-screen bg-gray-900 text-white flex flex-col items-center">
      ...
      <div className="w-full flex justify-center">
        <div className="mt-8 mb-4 px-6 py-4 bg-gray-800/60 backdrop-blur-sm rounded-lg border border-fuchsia-400/30 shadow-lg relative z-10 w-full max-w-4xl mx-4">
